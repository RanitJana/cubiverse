...
export default function Address() {
    ...
    async function handleAddAddress(e) {
        ...
        try {
            ...
            const response = await axios.post(`https://cubiverse-bakend.vercel.app/api/v1/address/add`,
                {
    ...
    async function handleEditAddress(e) {
        ...
        try {
            ...
            const response = await axios.post(`https://cubiverse-bakend.vercel.app/api/v1/address/edit/${index}`,
                {
                    address: e.target[0].value,
                    pincode: e.target[1].value
                },
    ...
    async function handleDeleteAddress(e, index) {
        try {
            const response = await axios.post(`https://cubiverse-bakend.vercel.app/api/v1/address/delete/${index}`, {}, {
                headers: {
                    "Content-Type": "application/json"
                },
                withCredentials: true
